<?php return array (
  ...
  array (
    ...
    'fallback_locale' => 'en',
    'faker_locale' => 'en_US',
    'key' => 'base64:VTn6A3fZ5Watp0ezRuHittkGlbYF5fDS/GCvHx6f/8g=',
    'cipher' => 'AES-256-CBC',
    'providers' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/home/ahmadshoh/web/nftapi.local/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/home/ahmadshoh/web/nftapi.local/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/home/ahmadshoh/web/nftapi.local/storage/app/public',
        'url' => 'http://nftapi.local/storage',
        'visibility' => 'public',
      ),
      's3' => 
      array (
    ...
    'links' => 
    array (
      '/home/ahmadshoh/web/nftapi.local/public/storage' => '/home/ahmadshoh/web/nftapi.local/storage/app/public',
    ),
  ),
  'hashing' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/home/ahmadshoh/web/nftapi.local/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/home/ahmadshoh/web/nftapi.local/resources/views/vendor/mail',
      ),
    ),
  ),
  'media-library' => 
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/home/ahmadshoh/web/nftapi.local/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    'paths' => 
    array (
      0 => '/home/ahmadshoh/web/nftapi.local/resources/views',
    ),
    'compiled' => '/home/ahmadshoh/web/nftapi.local/storage/framework/views',
  ),
  'debugbar' => 
  array (
    'enabled' => NULL,
    ...
    array (
      'enabled' => true,
      'driver' => 'file',
      'path' => '/home/ahmadshoh/web/nftapi.local/storage/debugbar',
      'connection' => NULL,
      'provider' => '',
      'hostname' => '127.0.0.1',
      'port' => 2304,
