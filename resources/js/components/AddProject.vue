                ...
                <div class="submit__right">
                    <form class="contacts__form form">
                        <label class="form__label bottom">
                            ...
                            <span class="t-text-red-400" role="alert" v-if="errors.hasOwnProperty('name')">
                                {{ getError('name') }}
                            </span>
                        </label>
                        ...
                        <label class="form__label bottom ">
                            <div class="form__info flex">
                                <div class="form__date">
                                    ...
                                    <input type="text" name="date-from" class="form__field field date-from" ref="startDate" placeholder="Start date" data-calendar-id="1" readonly>
                                </div>
                                <div class="form__date">
                                    <div class="form__date-icon svg-contain">
                                        <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <input type="text" name="date-to" class="form__field field date-to" ref="endDate" placeholder="Finish date" data-calendar-id="2" readonly>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="form__label bottom ">
                            <button class="form__btn btn btn_blue" @click="saveProject">
