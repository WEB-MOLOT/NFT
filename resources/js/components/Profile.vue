<template>
    <div class="personal-area">
        ...
        <add-project-modal ref="addProject"></add-project-modal>
        ...
        <div class="wrapper">
            ...
            <div class="personal-area__body bottom">
                <div class="personal-area__block active" data-personal-area-block="1">
                    <form @submit.prevent="updateUserData" class="personal-area__form form">
                        ...
                        <div class="personal-area__form-body flex">
                            <div class="personal-area__coll">
                                <label class="form__label bottom">
                                    ...
                                    <input type="text" v-model="user.email" class="form__field field" placeholder="E-Mail">
                                </label>
                                <label class="form__label bottom">
                                    <div class="form__caption">twitter</div>
                                    <input type="text" v-model="user.twitter" class="form__field field" placeholder="Enter your twitter">
                                </label>
                                <label class="form__label bottom">
                                    <div class="form__caption">telegram</div>
                                    <input type="text" v-model="user.telegram" class="form__field field" placeholder="Enter your telegram">
                                </label>
                            </div>
                            <div class="personal-area__coll">
                                <label class="form__label bottom password">
                                    <div class="form__caption">current password</div>
                                    <input type="password" v-model="user.current_password" class="form__field field" placeholder="Password*">
                                ...
                                <label class="form__label bottom password success">
                                    ...
                                    <input type="password" v-model="user.new_password" class="form__field field success" placeholder="Password*">
                                    <div class="password__icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M17.7141 9.13533C18.1091 9.65199 18.1091 10.3495 17.7141 10.8653C16.4699 12.4895 13.4849 15.8337 9.99993 15.8337C6.51493 15.8337 3.52993 12.4895 2.28576 10.8653C2.09358 10.6179 1.98926 10.3136 1.98926 10.0003C1.98926 9.68706 2.09358 9.38272 2.28576 9.13533C3.52993 7.51116 6.51493 4.16699 9.99993 4.16699C13.4849 4.16699 16.4699 7.51116 17.7141 9.13533V9.13533Z"
                                ...
                                <label class="form__label bottom password error">
                                    ...
                                    <input type="password" v-model="user.new_password_confirmation" class="form__field field error" placeholder="Password*">
                                    <div class="password__icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M17.7141 9.13533C18.1091 9.65199 18.1091 10.3495 17.7141 10.8653C16.4699 12.4895 13.4849 15.8337 9.99993 15.8337C6.51493 15.8337 3.52993 12.4895 2.28576 10.8653C2.09358 10.6179 1.98926 10.3136 1.98926 10.0003C1.98926 9.68706 2.09358 9.38272 2.28576 9.13533C3.52993 7.51116 6.51493 4.16699 9.99993 4.16699C13.4849 4.16699 16.4699 7.51116 17.7141 9.13533V9.13533Z"
...
<!--                                    </div>-->
<!--                                </a>-->
                                <a href="#" class="catalog__item project--js flex bottom bottom_visible" v-for="project in followedProjects">
                                    <div class="catalog__left">
                                        <div class="catalog__img img-cover">
                                            <img :src="project.logo" alt="">
                                        </div>
                                        <div class="catalog__verified flex" v-show="project.is_verified">
                                            <div class="catalog__verified-icon img-contain">
                                                <img src="img/catalog/verified-icon.svg" alt="">
                                            </div>
                                            <div class="catalog__verified-caption">
                            ...
                            <div class="catalog__bottom bottom" v-show="showMore">
                                <a @click="increaseLimit" class="catalog__btn flex-center">
                ...
                <div class="personal-area__block" data-personal-area-block="3">
                    <div class="personal-area-proects">
                        <a @click="showAddModal" class="personal-area-proects__top-btn flex">
                        ...
                        <div class="personal-area-proects__body">
                            <div class="personal-area-proects__items flex">
                                <div class="personal-area-proects__item" v-for="project in projects">
                                    <div class="personal-area-proects__img img-cover">
                                        <img :src="project.logo" alt="">
                                    </div>
                                    <div class="personal-area-proects__box">
                                        <div class="personal-area-proects__name">{{ project.name }}</div>
                                        <div class="personal-area-proects__box-bottom flex">
                                            <div class="personal-area-proects__info">
                                                ...
                                                <div class="personal-area-proects__info-box published flex" v-if="project.published">
                                                    <span>Published</span>
                                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <div class="personal-area-proects__info-box moderate flex" v-else>
                                                    <span>Moderate</span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M7.99992 1.33301C4.32392 1.33301 1.33325 4.32367 1.33325 7.99967C1.33325 11.6757 4.32392 14.6663 7.99992 14.6663C11.6759 14.6663 14.6666 11.6757 14.6666 7.99967C14.6666 4.32367 11.6759 1.33301 7.99992 1.33301ZM7.99992 13.333C5.05925 13.333 2.66659 10.9403 2.66659 7.99967C2.66659 5.05901 5.05925 2.66634 7.99992 2.66634C10.9406 2.66634 13.3333 5.05901 13.3333 7.99967C13.3333 10.9403 10.9406 13.333 7.99992 13.333Z"
                                            ...
                                            <div class="personal-area-proects__buttons flex">
                                                <a href="/promotion" class="personal-area-proects__btn">
                                                ...
                                                <a @click="showProjectModal(project)" class="personal-area-proects__btn">
                                                    <div class="personal-area-proects__btn-icon">
                                                ...
                                                <a @click="editProject(project)" class="personal-area-proects__btn">
                                                    <div class="personal-area-proects__btn-icon">
                                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                <a @click="showRemoveConfirmation(project)" class="personal-area-proects__btn delete--js">
                                                    <div class="personal-area-proects__btn-icon">
                                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
...
export default {
    ...
    components: {ProjectModal, DeleteModal, AddProjectModal},
    ...
    methods: {
        init() {
            axios.get('api/users/get-followed-projects/' + window.user.id, {params: {limit: this.limit}})
                .then(response => {
                    this.followedProjects = response.data.followedProjects;
                    this.showMore = response.data.showMore;
                })

            axios.get('api/users/get-projects/' + window.user.id)
                .then(response => {
        ...
        showRemoveConfirmation(project) {
            this.$refs.deleteModal.project = project;
            this.$refs.deleteModal.init();
        },

        editProject(project) {
            this.$refs.addProject.project = project;
            this.$refs.addProject.isEditing = true;
